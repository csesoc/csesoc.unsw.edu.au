...
func TestEnquirySuccessful(t *testing.T) {
	...
	t.Run("Handle successful sponsorship enquiry", func(t *testing.T) {
		resp, err := http.PostForm("http://localhost:1323/api/v1/mailing/sponsorship", formCorrectData)
		if err != nil {
	...
	t.Run("Handle successful general enquiry", func(t *testing.T) {
		resp, err := http.PostForm("http://localhost:1323/api/v1/mailing/general", formCorrectData)
		if err != nil {
			t.Errorf("Could not perform POST request")
		}
		defer resp.Body.Close()
...
func TestEnquiryUnsuccessful(t *testing.T) {
	t.Run("Handle request with missing name", func(t *testing.T) {
		...
		resp, err := http.PostForm("http://localhost:1323/api/v1/mailing/sponsorship", formIncorrectData)
		if err != nil {
			t.Errorf("Could not perform POST request")
		}
		defer resp.Body.Close()
...
func TestFeedbackSuccessful(t *testing.T) {
	t.Run("Feedback Successful", func(t *testing.T) {
		resp, err := http.PostForm("http://localhost:1323/api/v1/mailing/feedback", url.Values{
			"name":  {"John Smith"},
